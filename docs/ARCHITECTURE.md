...
| `CLONE_REPO_ALLOWLIST` | empty | Comma-separated exact GitHub `owner/name` slugs the conversational `clone_repo` tool may clone. Empty/unset denies model-chosen clones before leasing or spawning Docker. |
